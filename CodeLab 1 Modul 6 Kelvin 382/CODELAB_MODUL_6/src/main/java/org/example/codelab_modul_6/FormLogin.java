...
public class FormLogin extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Untuk useranme dan password saya : "kelviin"
        ...
        login.setOnAction(e -> {
            ...
            if ("kelviin".equals(username) && "202310370311382".equals(password)) {
                primaryStage.setScene(welcomeScene);
            } else {
                Alert alert = new Alert(AlertType.ERROR);
                alert.setTitle("Login Error");
                alert.setHeaderText(null);
                alert.setContentText("Username / Password salah. 'Kamu Bukan Kelviin");
                alert.showAndWait();
            }
        });
        ...
        Label hello = new Label("Welcome Home kelviin");
